...
FILE_ASSIGNMENTS = {
    ...
    "blockchain/raw/channels.md": ("Mantle", "Channels"),
    ...
    "blockchain/raw/template-bridged-zone.md": ("Mantle", "[Template] Bridged Zone"),
    ...
    "blockchain/raw/analysis-channel-collateral.md": ("Mantle", "[Analysis] Channel Collateral"),
