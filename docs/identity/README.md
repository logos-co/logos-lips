...
Identity covers protocols for account identity: how an account is named,
how it endorses keys and records for the applications that use it,
and how anyone can verify those endorsements independently.
...
<div id="rfc-table-container" class="table-wrap" data-component="identity"></div>
