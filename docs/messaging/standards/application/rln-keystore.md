...
A [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/17/rln-relay.md)
keystore stores a node's credentials locally and
[32/RLN-V1](https://github.com/logos-co/logos-lips/blob/master/docs/ift-ts/raw/32/rln-v1.md) is used as a spam-prevention mechanism with the help of zero-knowledge proofs.
...
With [32/RLN-V1](https://github.com/logos-co/logos-lips/blob/master/docs/ift-ts/raw/32/rln-v1.md), sending and receiving 
...
A format example of a keystore used by a [17/WAKU2-RLN-Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/17/rln-relay.md).
...
as decribed in [32/RLN-V1](https://github.com/logos-co/logos-lips/blob/master/docs/ift-ts/raw/32/rln-v1.md).
...
## References
1. [32/RLN-V1](https://github.com/logos-co/logos-lips/blob/master/docs/ift-ts/raw/32/rln-v1.md)
2. [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/17/rln-relay.md)
