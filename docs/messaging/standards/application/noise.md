...
This specification describes how payloads of [Waku messages](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14) with [version 2](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14) can be encrypted
...
This specification extends the functionalities provided by [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/application/26/payload.md),
...
In the following, we assume that communicating parties reciprocally know an initial [`contentTopic`](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14/#wakumessage)
...
When [14/WAKU-MESSAGE version](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14/#payload-encryption) is set to 2,
...
It is possible to have backward compatibility to symmetric/asymmetric encryption primitives from [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/application/26/payload.md),
effectively encapsulating payload encryption [14/WAKU-MESSAGE version 1](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14/#version1) in [version 2](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14/#version2).
...
and set the `transport-message` field to the [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/application/26/payload.md) `data` field, whenever these `protocol-id` values are set.
...
- `transport-message`: contains the [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/application/26/payload.md) `data` field (AES-256-GCM or ECIES, depending on `protocol-id`);
- `transport-message-len` is set accordingly to `transport-message` length;

When a `transport-message` corresponding to `protocol-id = 254, 255` is retrieved,
it SHOULD be decoded as the `data` field in [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/application/26/payload.md) specification.
...
2. [10/WAKU2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/10/waku2.md)
3. [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/application/26/payload.md)
4. [14/WAKU-MESSAGE](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/standards/core/14)
