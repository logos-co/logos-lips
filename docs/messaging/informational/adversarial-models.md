...
Future versions of this document will serve as a comprehensive list of adversarial models and attack based threats relevant for [Waku v2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/10/waku2.md).
...
Because each [Waku message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/14/message.md) is associated with a content topic, and each receiver is interested in messages with specific content topics,
...
The following lists various attacks against [Waku v2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/10/waku2.md) protocols.
If not specifically mentioned, the attacks refer to [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/11/relay.md) and the underlying [libp2p GossipSub](https://github.com/libp2p/specs/blob/master/pubsub/gossipsub/README.md).
...
For [Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/11/relay.md) this means we only consider messages with version field `2`,
...
The [data field of Waku v2 relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/11/relay.md/#message-fields) must be a [Waku v2 message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/14/message.md).
...
Further, replay attacks will be punished by [RLN Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/17/rln-relay.md).
...
Waku employs [RLN Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/17/rln-relay.md) as the main countermeasure to flooding.
...
- [Waku v2 message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/14/message.md)
...
- [17/WAKU-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/17/rln-relay.md)
