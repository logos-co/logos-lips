...
| ----- | ------------ | --------------------------------------------------------------- |
| 0     | global       | global use                                                      |
| 1     | reserved     | [The Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/64/network.md) |
| 2     | reserved     |                                                                 |
| 3     | reserved     |                                                                 |
| 4     | reserved     |                                                                 |
| 5     | reserved     |                                                                 |
...
- [The Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/standards/core/64/network.md)
