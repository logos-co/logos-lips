...
- **2026-03-23** — [`011eea8`](https://github.com/logos-co/logos-lips/blob/011eea8f069feed3a4feee1c2cc2669f8ed498d9/docs/anoncomms/raw/1/coss.md) — docs(1/coss): add Approved/Verified statuses, CFR doc type, and raw-spec leniency (#301)
- **2026-01-16** — [`f01d5b9`](https://github.com/logos-co/logos-lips/blob/f01d5b9d9f2ef977b8c089d616991b24f2ee4efe/docs/anoncomms/raw/1/coss.md) — chore: fix links (#260)
- **2026-01-16** — [`89f2ea8`](https://github.com/logos-co/logos-lips/blob/89f2ea89fc1d69ab238b63c7e6fb9e4203fd8529/docs/anoncomms/raw/1/coss.md) — Chore/mdbook updates (#258)
...
Request For Comments specification process managed by the AnonComms service department
...
For example, this specification should be **lip.logos.co/process/draft/1/coss**,
...
For example, this specification is **lip.logos.co/process/draft/1/coss**.
...
AnonComms is a department under the IFT organization that provides RFC (Request For Comments)
