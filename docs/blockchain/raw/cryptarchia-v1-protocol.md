...
> **TODO before merge (PR 457).** The transactions of the second row include a `ChannelTransfer` leaf, an Operation Mantle 1.16.0 removes. The row and the body roots derived from it are regenerated with the Mantle vectors.
