...
| 1.7.0 | `DeclarationMessage` and `DeclarationInfo` carry a `stark_zk_id`, the declaration's STARK-field zero-knowledge identity, bound to at most one declaration | 2026-09-07 |
