...
| 1.6.0 | [RFC] SDP operations address a declaration by `ZkId` and `ServiceType` instead of `DeclarationId` | 2026-08-19 |
...
SDPWithdraw   = ZkId ServiceType Nonce LockedNoteId
Nonce         = UINT64

SDPActive     = ZkId ServiceType Nonce Metadata
