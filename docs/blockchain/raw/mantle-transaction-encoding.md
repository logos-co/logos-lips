...
| 1.9.0 | `Note`, `LeaderClaim`, `ClaimPowReward` and `SDPDeclare` carry a `StarkPublicKey`; new `StarkPublicKey` common structure | 2026-09-07 |
...
```schema
ClaimPowReward = EpochNonce BlockHash PublicKey StarkPublicKey
