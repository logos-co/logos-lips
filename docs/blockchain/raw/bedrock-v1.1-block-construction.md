...
| 1.2.1 | Noted that transaction maturity is preserved when a proposal is broadcast while the Blend Network is bypassed, following [Blend Protocol](blend-protocol.md). | 2026-08-21 |
