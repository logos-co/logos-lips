...
| 1.14.0 | [RFC] The `declaration_id` is the hash of the service and the `zk_id`; a note backs one declaration per service, and `SDP_WITHDRAW` no longer names the note | 2026-09-11 |
